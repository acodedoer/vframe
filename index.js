...
function setCategories(e, toolbox){
 ...
 function setDiv(e, div="instructions"){
    const nav = `<nav class="testTab" id ="testTab">
    <button id="btninstructions" class="tablinks active" onclick="setDiv(event, 'instructions')">Instructions</button>
    <button id ="btnfinal" class="tablinks" onclick="setDiv(event,'final')">Final Scene</button>
    </nav>`
   let str = "";
