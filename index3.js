...
function setCategories(e, toolbox){
 ...
 let str = "";
  const inst = `<div id = "instructions">Use the Components and Primitive blocks, and the blocks already added in the workspace (to the left) to complete the tasks below. Your completed scene, which will be shown in the pane above, should look like the scene shown on the Final Scene tab.
  <ol>
